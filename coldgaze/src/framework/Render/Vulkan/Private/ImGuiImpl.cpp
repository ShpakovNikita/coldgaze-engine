...
void CG::Vk::ImGuiImpl::InitResources(VkRenderPass renderPass, VkQueue copyQueue)
{
    ...
    VkPipelineMultisampleStateCreateInfo multisampleState = Initializers::PipelineMultisampleStateCreateInfo(static_cast<VkSampleCountFlagBits>(engine.GetSampleCount()));
